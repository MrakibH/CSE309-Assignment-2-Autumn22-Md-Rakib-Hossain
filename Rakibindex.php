...
<html lang="en">
  ...
  <body>
    <div class="container w-60 m-auto">
        <div class="text">
            <h1 class="text-center">Contact Us</h1>
            <hr class="w-60 m-auto bg-dark">
            <h2 class="text-center">Give the correct informations below:</h2>
        </div>
        <form action="Rakibaction.php" method="POST" autocomplete="off">
            <div class="user my-4">
            ...
            <button class="btn btn-success">Send The Message</button>
        </form>
    </div>
